...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> TaskExceptionHandler(StoreLocationException ie, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> stockkExceptionHandler(StockMovementException ie, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> stockExceptionHandler(StockItemNotFoundException ie, WebRequest req){
